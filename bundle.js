...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_leancloud_storage__ = __webpack_require__(6);
...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    methods:{
        ...
        saveTodos:function(){
            ...
            var Todofolder = __WEBPACK_IMPORTED_MODULE_1_leancloud_storage___default.a.Object.extend('Todofolder')
        ...
        fetchTodos:function(){
            if(this.currentUser){
                var query = new __WEBPACK_IMPORTED_MODULE_1_leancloud_storage___default.a.Query('Todofolder')
                query.find()
                    .then((todos)=> {
